...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of gem_loader_v_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins gem_loader_v_0/S_CFG_AXI]
	connect_bd_net [get_bd_pins gem_loader_v_0/s_cfg_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins gem_loader_v_0/s_cfg_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins gem_loader_v_0/S_C2C_AXI]
	connect_bd_net [get_bd_pins gem_loader_v_0/s_c2c_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins gem_loader_v_0/s_c2c_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to gem_loader_v_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/gem_loader_v_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_gem_loader_v_0_S_C2C_AXI_* ]]
	puts $fp "set s_c2c_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_gem_loader_v_0_S_CFG_AXI_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/gem_loader_v_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "gem_loader_v_v1_0_hw_${i}"
